...
<html lang="en">
    ...
    <body>
        ...
        <header >
			<div class="main-head"><p class="main-heading">CONSTRUCTION LABOURS</p></div>
			<div class="container3">
				<div class="box3">
					<div class="content3">
						<img src="resource/img/MASON.jpg" class="img3">
						<p class="btn3">MASON</p>
					</div>
				</div>
				<div class="box3">
					<div class="content3">
						<img src="resource/img/CARPENTER.jpg" class="img3">
						<p class="btn3">CARPENTER</p>
					</div>
				</div>
				<div class="box3">
					<div class="content3">
						<img src="resource/img/PAINTER.jpg" class="img3">
						<p class="btn3">PAINTER</p>
					</div>
				</div>
				<div class="box3">
					<div class="content3">
						<img src="resource/img/ELECTRICIAN.jpg" class="img3">
						<p class="btn3">ELECTRICIAN</p>
					</div>
				</div>
				<div class="box3">
					<div class="content3">
						<img src="resource/img/PLUMBE.jpg" class="img3">
						<p class="btn3">PLUMBER</p>
					</div>
				</div>
				<div class="box3">
					<div class="content3">
						<img src="resource/img/MAJDOOR.jpg" class="img3">
						<p class="btn3">MAJDOORS</p>
					</div>
				</div>
				<div class="box3">
					<div class="content3">
						<img src="resource/img/helper.jpg" class="img3">
						<p class="btn3">HELPERS</p>
					</div>
				</div>
				<div class="box3">
					<div class="content3">
						<img src="resource/img/mshift.jpg" class="img3">
						<p class="btn3">SHIFTING LABOUR</p>
					</div>
				</div>
			</div>
        </header>

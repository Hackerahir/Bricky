        ...
        <header>
			<section class="login-form">
				<div class="login-box2">
					<h3 align="center">POST  LABOUR</h3>
					<form name="eqptreg form" action="postlab2.php" method="post">
					<div class="textbox">
					...
					<div class="textbox">
						...
						<select id="labtype" name="labtype" >
							<option selected disabled>Labour Type</option>
							...
							<option value="shiftinglabour">Shifting Labour</option>
						</select>	
					</div>
					<div class="textbox">
						<i class="fa fa-table"></i>
						<input type="textbox" placeholder="Labour Name" id="labname" name="labname">
					</div>
					<div>
						<i class="fa fa-venus-mars"></i>
						<input type="number" placeholder="Number Of Labour" id="no" name="no">
					</div>
					<br>
					<br>

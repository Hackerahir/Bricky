        ...
        <header>
			<section class="login-form">
				<div class="login-box2">
					...
					<h3 align="center">POST  EQUIPMENT</h3>
					<form name="eqptreg form" action="posteqpt2.php" method="post">
					<div class="textbox">
						<i class="fa fa-user"></i>
						<input type="text" placeholder="Full Name" name="fullname" id="fullname" name="fullname">
					</div>
					<div class="textbox">
    ...
    <select name="city" id="city">
        ...
        <option value="">Select state first</option>
					...
					<div class="textbox">
						...
						<input type="textbox" placeholder="Equipmment Name" id="eqptname" name="eqptname">
					</div>
					<div>
						<i class="fa fa-calendar"></i>
						<input type="number" placeholder="Make Year" id="year" name="year" min="1990" max="2020">
					</div>
					<br>
					<br>
